...
MODEL_CONFIGS = {
    ...
    "RoBERTa":               ("roberta", os.path.join(REPO, "model_training/roberta_models", "base_roberta")),
    "RoBERTa (adversarial)":               ("roberta", os.path.join(REPO, "model_training/roberta_models", "adverse_roberta_dynamic_2")),
}
